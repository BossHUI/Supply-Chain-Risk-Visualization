...
.
├── main.py                              # 主程序文件
├── research_assessment_manager_report.md # 风险报告示例（单文件模式）
├── honda_risk_viz.html                  # 生成的交互式地图（单文件模式）
├── index.html                           # 主页面（批量模式，包含下拉框）
├── coordinate_cache.json                 # 坐标缓存文件（自动生成）
├── reports/                             # 报告目录（批量模式）
│   ├── 2026-01-14_20-23-57/
│   │   ├── research_assessment_manager_report.md
│   │   └── 2026-01-14_20-23-57_map.html
│   ├── 2026-01-15_17-23-59/
│   │   ├── research_assessment_manager_report.md
│   │   └── 2026-01-15_17-23-59_map.html
│   └── 2026-01-16_10-58-13/
│       ├── research_assessment_manager_report.md
│       └── 2026-01-16_10-58-13_map.html
├── README.md                            # 项目说明文档
└── .gitignore                           # Git 忽略文件
```
...
如果您的报告存放在 `reports` 目录下，可以使用批量处理模式：
...
批量处理模式会：
1. 自动扫描 `reports` 目录下的所有子目录
2. 为每个子目录中的 `research_assessment_manager_report.md` 生成对应的地图HTML文件
3. 创建一个主页面 `index.html`，包含下拉框可以选择不同的报告
...
└── 2026-01-16_10-58-13/
    ├── research_assessment_manager_report.md
    └── 2026-01-16_10-58-13_map.html
index.html  # 主页面，包含下拉框选择不同报告
```

打开 `index.html` 即可通过下拉框选择不同的报告进行查看。
